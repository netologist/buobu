  ...
  return (
    <Card className="w-full">
      <CardHeader className="space-y-1">
        ...
        <CardDescription>Sign in with OAuth or use your email/password.</CardDescription>
      </CardHeader>
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-4">
          {(oauthError || validationError || error) && (
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/forgot-password" tabIndex={-1} className="text-xs text-muted-foreground hover:text-primary hover:underline">
                Forgot password?
              </Link>
            </div>
            <Input
